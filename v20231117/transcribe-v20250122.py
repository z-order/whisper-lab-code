...
def transcribe(
    ...
    **decode_options,
    ...
    """
    logger.debug(f'module(build): {__file__} (transcribe.py) -> transcribe()')
        ...
        while clip_idx < len(seek_clips):
            ...
            if verbose:
                for segment in current_segments:
                    ...
                    yield {"start": format_timestamp(start, True), "end": format_timestamp(end, True), "text": text, "segment": segment}
